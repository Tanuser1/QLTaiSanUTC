...
interface BentoTile {
  ...
  colSpan?: number;       // 1 | 2 (in 3-col grid)
  rowSpan?: number;       // 1 | 2
}
...
const TILES: BentoTile[] = [
  {
    ...
    label: 'TỔNG THIẾT BỊ',
    sub: 'Toàn trường',
    trend: { dir: 'up', text: '+120 so với tháng trước' },
  },
  {
    id: 'active',
    color: '#4db6ac',
    ...
    sub: '83.5% tổng số',
    trend: { dir: 'up', text: '+2.1% so với tháng trước' },
  },
  {
    id: 'maintenance',
    color: '#ef5350',
    ...
    label: 'ĐANG BẢO TRÌ',
    sub: '7.3% cần xử lý',
    trend: { dir: 'down', text: '-5 so với tuần trước' },
  },
  {
    id: 'requests',
    color: '#ffa726',
  ...
  },
  {
    ...
    icon: Monitor,
    value: '450',
    label: 'MÁY TÍNH PHÒNG LAB',
    sub: '18 phòng Lab',
    trend: { dir: 'neutral', text: 'Không thay đổi' },
    colSpan: 2,
  },
  {
    id: 'projectors',
    ...
    icon: Activity,
    value: '120',
    label: 'MÁY CHIẾU GIẢNG ĐƯỜNG',
    sub: '97 đang hoạt động',
  },
  {
    id: 'overdue',
    color: '#ee665f',
    ...
    trend: { dir: 'up', text: '+8 so với tháng trước' },
  },
  {
    id: 'staff-laptop',
    color: '#fdd835',
...
const BentoCard: React.FC<{ tile: BentoTile }> = ({ tile }) => {
  ...
  return (
    ...
    >
      {/* ── BIG BACKGROUND ICON (10% opacity, rotated) ── */}
      <div
      ...
      {/* ── TOP ROW: small icon + trend badge ── */}
      <div className="flex items-start justify-between z-10 relative">
        ...
        {tile.trend && (
          ...
          >
            ...
            {tile.trend.dir === 'down' && (
              <ArrowUpRight size={11} style={{ transform: 'rotate(90deg)' }} />
            )}
      ...
      <div className="z-10 relative">
        ...
        <p
          ...
          style={{ color: textColor, fontFamily: 'Inter, sans-serif', letterSpacing: '0.1em' }}
        >
          {tile.label}
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            <a
              ...
              style={{ color: '#303f9f', fontFamily: 'Inter, sans-serif' }}
            >
          ...
          <div className="px-5 py-2">
            {ACTIVITY.map((a, i) => (
              <div
                ...
                style={{ borderBottom: i < ACTIVITY.length - 1 ? '1px solid #f0f2f5' : 'none' }}
              >
                <span
                  className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5"
                  style={{ backgroundColor: a.dot }}
                />
                <span className="flex-1 text-sm" style={{ color: '#37474f', fontFamily: 'Inter, sans-serif' }}>
                  {a.text}
                </span>
                <span className="text-[11px] flex-shrink-0" style={{ color: '#90a4ae' }}>
                  {a.time}
                </span>
              </div>
            ))}
            ...
            {[
              ...
              <div key={cat.label} className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  <span className="text-[12px]" style={{ color: '#546e7a', fontFamily: 'Inter, sans-serif' }}>
                    {cat.label}
                  </span>
                  <span
                ...
                <div className="h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: '#f0f2f5' }}>
                  <div
                    ...
                    style={{ width: `${cat.pct}%`, backgroundColor: cat.color, transition: 'width 0.6s ease' }}
                  />
                </div>
              </div>
            ))}
