...
type TextVariant = 'headline-xl' | 'headline-lg' | 'headline-md' | 'body-lg' | 'body-md' | 'label-bold' | 'label-sm' | 'data-tabular';
...
const variantElement: Record<TextVariant, React.ElementType> = {
  'headline-xl': 'h1', 'headline-lg': 'h2', 'headline-md': 'h3',
  'body-lg': 'p', 'body-md': 'p',
  'label-bold': 'span', 'label-sm': 'span', 'data-tabular': 'span',
};

export const Typography: React.FC<TypographyProps> = ({ variant, as, className = '', children }) => {
