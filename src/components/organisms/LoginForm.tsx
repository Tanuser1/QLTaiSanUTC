  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            autoComplete="email"
            className={`
              w-full pl-10 pr-4 py-2.5 text-sm rounded border bg-white
              text-[#191c1d] placeholder:text-[#74777d] outline-none transition-all
              ${errors.email
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`
              w-full pl-10 pr-10 py-2.5 text-sm rounded border bg-white
              text-[#191c1d] placeholder:text-[#74777d] outline-none transition-all
              ${errors.password
                ? 'border-[#ba1a1a] focus:ring-1 focus:ring-[#ba1a1a]'
                : 'border-[#c4c6cd] focus:border-[#26a69a] focus:ring-1 focus:ring-[#26a69a]'
      ...
      <div className="flex items-center justify-between">
        ...
        <a href="#" className="text-sm text-[#26a69a] hover:underline font-medium">
          Quên mật khẩu?
        </a>
      </div>
